...
let allComic: [comic] = [
    // 액션
    comic(title: "원피스", price: 9000, category: "액션"),
    comic(title: "원펀맨", price: 8000, category: "액션"),
    comic(title: "귀멸의 칼날", price: 9000, category: "액션"),
    comic(title: "주술회전", price: 7500, category: "액션"),
    comic(title: "스파이 패밀리", price: 7500, category: "액션"),
    comic(title: "괴수 8호", price: 7000, category: "액션"),
    comic(title: "나루토", price: 8000, category: "액션"),
    comic(title: "블리치", price: 8800, category: "액션"),
    comic(title: "드래곤볼", price: 8600, category: "액션"),
    comic(title: "헌터헌터", price: 8200, category: "액션"),
    comic(title: "이누야샤", price: 8400, category: "액션"),
    comic(title: "도쿄리벤져스", price: 7800, category: "액션"),
